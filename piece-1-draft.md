...
A wheeling transaction works by crediting a customer for the Eskom energy they no longer buy. That credit is the entire economic basis of the 20 to 30% saving that wheeled power purchase agreements are marketed on. This clause carves the generation capacity charge out of it.
...
The phase-in does not change that immunity. It changes only whether the unavoidable cost is assessed on your kVA or on your kWh. So for a wheeling customer the lever against this charge is demand management, not energy substitution. A model that credits any part of the GCC back to the customer overstates the saving.
